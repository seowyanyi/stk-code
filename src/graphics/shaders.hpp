...
class ShadowedSunLightShaderPCF : public ShaderHelperSingleton<ShadowedSunLightShaderPCF, float, float, float, float>, public TextureRead<Nearest_Filtered, Nearest_Filtered, Nearest_Filtered, Shadow_Sampler>
{
public:
